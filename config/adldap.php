            ...
            */
            ...
            'connection_settings' => [
                ...
                */
                ...
                'domain_controllers' => explode(' ', env('ADLDAP_CONTROLLERS', 'ivas.local')),
                ...
                */
                ...
                'base_dn' => env('ADLDAP_BASEDN', 'dc=ivas.local,dc=corp,dc=acme,dc=org'),
                ...
                */
                ...
                'admin_account_suffix' => env('ADLDAP_ADMIN_ACCOUNT_SUFFIX', '@ivas.local'),
                ...
                */
                ...
                'admin_password' => env('ADLDAP_ADMIN_PASSWORD', 'ywHobrr-!nF8'),
